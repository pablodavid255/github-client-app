class UI {
  constructor() {
  	...
  	this.text = document.getElementById('texto')
  }
  showProfile(user) {
  	this.profile.innerHTML = `
	  <div class="card mt-2 animate__animated animate__slideInLeft">
  ...
  showRepositories(repositories) {
    ...
    repositories.forEach(repo => {
      template += `
        <div class="card card-body mt-2 animate__animated animate__slideInRight">
          <div class="row">
            <div class="col-md-6">
  ...
  reset() {
    this.text.innerHTML = `
        ...
        <h3 class="display-2">Learn Something New Everydary</h3>
    `
  }
}
